...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    - The relational database is the system and SQL is the language used to interact with it.

- [ ] Why do tables need a `primary key`?

    - So that each row in the table has a unique identifier, that can be used to reference that row.
